...
<body>
	<p class="pLink">
		<a href="<c:url value='/ordermanage/findbystatus/1'/>">未付款</a> |
		<a href="<c:url value='/ordermanage/findbystatus/2'/>">已付款</a> | 
		<a href="<c:url value='/ordermanage/findbystatus/3'/>">已发货</a> |
		<a href="<c:url value='/ordermanage/findbystatus/4'/>">交易成功</a> | 
		<a href="<c:url value='/ordermanage/findbystatus/5'/>">已取消</a>
	</p>
	<div class="divMain">
		<div class="title">
		...
		<tr style="padding-top: 10px; padding-bottom: 10px;">
			...
			<td >
				<a href="<c:url value='/ordermanage/todesc/${dingdan.oid}'/>">查看</a><br/>
				<c:if test="${dingdan.status eq 1 }">
					<a href="<c:url value='/ordermanage/todesc/${dingdan.oid}'/>">取消</a><br/>
				</c:if>
				<c:if test="${dingdan.status eq 2 }">
					<a href="<c:url value='/ordermanage/todesc/${dingdan.oid}'/>">发货</a><br/>
				</c:if>
			</td>
		</tr>
		</c:forEach>
