...
<body>
	<ul>
		<c:forEach items="${books}" var="book">
			<li>
				<div class="inner">
					<a class="pic" href="<c:url value='/bookmanage/selectbybid/${book.bid}'/>">
					...
					<p>
						<a id="bookname" title="${book.bname}" 
							href="<c:url value='/bookmanage/selectbybid/${book.bid}'/>">${book.bname}</a>
					</p>
					<p>
						<a href="<c:url value='/bookmanage/getauthor/${book.author}'/>"
							name='P_zz' title='${book.author}'>${book.author}</a>
					</p>
					<p class="publishing">
						<span>出 版 社：</span>
						<a href="<c:url value='/bookmanage/getpress?press=${book.press}'/>">${book.press}</a>
					</p>
