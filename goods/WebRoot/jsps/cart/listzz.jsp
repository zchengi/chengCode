			...
			<table width="95%" align="center" cellpadding="0" cellspacing="0">
				...
				<c:forEach items="${cartItems}" var="cartItem">
					<tr align="center">
						...
						<td><span>&yen;<span class="currPrice"
								id="12345CurrPrice">${cartItem.currprice}</span></span></td>
						<td><a class="jian"
							...
							class="quantity" readonly="readonly" id="12345Quantity"
							type="text" value="${cartItem.cartItem.quantity}" /><a
							class="jia"
						...
						<td width="100px"><span class="price_n">&yen;<span
								class="subTotal" id="12345Subtotal">${cartItem.subTotal}</span></span></td>
						<td><a
							href="<c:url value='/cartitem/removecartitem/${cartItem.cartItem.cartitemid}'/>">删除</a></td>
					</tr>
					<script>
				...
				<tr>
					...
					<td colspan="3" align="right" class="tdTotal"><span>总计：</span><span
						class="price_t">&yen;</span> <script type="text/javascript">
