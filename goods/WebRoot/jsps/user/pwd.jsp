...
<div class="div1">
	<form action="<c:url value='/user/editpwd/${sessionScope.user.uid}'/>"
		...
		<table>
			...
			<tr>
				<td align="right"></td>
				<td>
					<img id="vCode" src="<c:url value ='/validate/getverify'/>" border="1" /> 
					<a href="javascript:_change();">看不清，换一张</a>
				</td>
			</tr>
			<tr>
				<td align="right">验证码:</td>
				<td><input class="input" type="text" name="verifyCode" id="verifyCode" value="" /></td>
