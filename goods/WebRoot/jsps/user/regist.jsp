...
<div id="divMain">
	...
	<div id="divBody">
		<form action="<c:url value='/user/reguser'/>" method="post">
			<table id="tableForm">
				<tr>
					<td class="tdText">用户名：</td>
					<td class="tdInput">
						<input class="inputClass" type="text" maxlength="15" name="loginname" id="loginname" />
					</td>
					<td class="tdError">
				...
				<tr>
					...
					<td>
						<div id="divVerifyCode">
							<img id="imgVerifyCode" src="<c:url value='/validate/getverify'/>" />
						</div>
					</td>
